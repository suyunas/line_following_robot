...
def main():
	om_remove_object = om_remove_class()
	names1 = 'position1'
	...
	while not ctrl_c:
		rate.sleep()
		#om_remove_object.move_home(arm_group)
		rate.sleep()
		om_remove_object.open_gripper(gripper_group,gripper_group_variable_values)
		rate.sleep()
		om_remove_object.move_position1(arm_group)
		rate.sleep()
		om_remove_object.close_gripper(gripper_group, gripper_group_variable_values)
		rate.sleep()
		#om_remove_object.move_home(arm_group)
		rate.sleep()
		om_remove_object.move_position2(arm_group)
		rate.sleep()
		om_remove_object.move_position3(arm_group)
		rate.sleep()
		om_remove_object.open_gripper(gripper_group,gripper_group_variable_values)
		rate.sleep()
		om_remove_object.move_position2(arm_group)
